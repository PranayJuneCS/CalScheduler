class ClassOverview extends React.Component {
  ...
  showCalendar() {
    return {
      __html: '<iframe id="cal-iframe" src="https://calendar.google.com/calendar/embed?mode=MONTH&amp;title=Your%20Calendar&amp;showTitle=0&amp;showPrint=0&amp;showCalendars=0&amp;height=600&amp;wkst=1&amp;bgcolor=%23336666&amp;src=' + encodeURIComponent(this.props.user.email) + '&amp;color=%23691426&amp;ctz=America%2FLos_Angeles&amp;dates=20170801%2F20170831" style="border:solid 1px #777" height="600" frameborder="0" scrolling="yes"></iframe>'
    }
  }
